...
class HelpDropdown(discord.ui.Select):
    def __init__(self, help_command: "Help", options: list[discord.SelectOption]):
...
class HelpView(discord.ui.View):
    def __init__(self, help_command: "Help", options: list[discord.SelectOption], *, timeout: Optional[float] = 120.0):
